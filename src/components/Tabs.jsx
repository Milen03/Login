...
export default function Tabs() {
   ...
   const tabs = [
                ...
                {id:5,title:'useMemo and useCallback',content:'useMemo се използва за запазване на изчислена стойност, за да не се пресмята отново при всеки render.useCallback се използва за запазване на функция, за да не се създава наново при всеки render.'}
            ];
